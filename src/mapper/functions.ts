import { CurryableMapper, Mapper } from "./types";
 ...
 */
export function compose<X, Y, Z>(xToY: Mapper<X, Y>, yToZ: Mapper<Y, Z>): Mapper<X, Z>;
export function compose<X, Y, Z>(xToY: Mapper<X, Y>, yToZ: Mapper<Y, Z>, x: X): Z;
 ...
 */
export function curry<T, U>(mapper: Mapper<T, U>, input?: T): CurryableMapper<T, U> {
